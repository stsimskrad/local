...
class ReportController extends Controller
{
    ...
    public function category(){
        ...
        foreach($datas as $data){
            ...
            $graduate = Scholar::where('program_id',$data->id)->where('status_id',35)->count();
            $good = Scholar::where('program_id',$data->id)->where('status_id',30)->count();
            $warning = Scholar::where('program_id',$data->id)->whereNotIn('status_id',[30,35])->count();
