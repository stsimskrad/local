                        ...
                        <div class="col-md-12">
                            ...
                            <div v-if="advanced == true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <multiselect @input="onChange(level,'level')" v-model="level" :options="levels"
        ...
        methods: {
            ...
            fetchUsers(){
                ...
                let info = {
                    ...
                    'school' : (this.school != '' && this.school != null) ? this.school.id  : '-',
                    'level' : (this.level != '' && this.level != null) ? this.level.id  : '-',
                    'year' : (this.year != '' && this.year != null) ? this.year : '-',
                };

                axios.get(this.currentUrl+'/request/scholar/filter/'+JSON.stringify(info))
                .then(response => {
