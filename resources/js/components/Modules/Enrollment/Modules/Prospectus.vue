...
<div>
    <div class="card-body border-bottom">
        ...
        <div class="float-end mt-n2">
            <button @click="back" type="button" class="mt-n4 btn btn-sm btn-label btn-secondary"><i class="bx bxs-chevrons-left label-icon"></i> Close </button>
        </div>
    </div>
    <div class="card-body" :style="{ height: (height-65) + 'px' }">
        <div class="row"> 
